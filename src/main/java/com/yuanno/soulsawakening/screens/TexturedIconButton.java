...
public class TexturedIconButton extends Button
{
	...
	public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
	{
		...
		RendererHelper.drawIcon(this.texture, matrixStack, this.texturePosX, this.texturePosY, 1, this.textureWidth, this.textureHeight, red, green, blue, 1);
		...
		matrixStack.pushPose();
		{
			...
			if(splits > 1)
				...
				//strings = Beapi.splitString(font, this.getMessage().getString(), this.textPosX - font.width(this.getMessage()) / 2 + 26, (this.width / splits) + 10);
		...
		//if(WyDebug.isDebug())
		//	this.fillGradient(this.x, this.y, this.width + this.x, this.height + this.y, Beapi.hexToRGB("#FF0000").getRGB(), Beapi.hexToRGB("#FF5500").getRGB());
