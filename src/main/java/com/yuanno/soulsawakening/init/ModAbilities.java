...
public class ModAbilities {
    ...
    public static final Ability[] HEAL_ZANPAKUTO = new Ability[] {HealingTouchAbility.INSTANCE, RevitilazingAuraAbility.INSTANCE, SelfHealingAbility.INSTANCE, SecondChanceAbility.INSTANCE};
