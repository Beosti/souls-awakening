...
import com.yuanno.soulsawakening.abilities.elements.poison.*;
...
public class ModAbilities {
    ...
    public static final Ability[] THUNDER_ZANPAKUTO = new Ability[] {ThunderStepAbility.INSTANCE, ThunderAttackAbility.INSTANCE, ThunderStrikeAbility.INSTANCE, ThunderballAbility.INSTANCE, ThunderBoostAbility.INSTANCE};
    ...
    public static final Ability[] POISON_ZANPAKUTO = new Ability[] {PoisonAttackAbility.INSTANCE, VenomousCloudAbility.INSTANCE, AdrenalineCloudAbility.INSTANCE, PoisonStingAbility.INSTANCE, AntidoteAbility.INSTANCE};
    public static final Ability[] WATER_ZANPAKUTO = new Ability[] {AquaSlashAbility.INSTANCE, TidalWaveAbility.INSTANCE, WaterPrisonAbility.INSTANCE, WaterSurgeAbility.INSTANCE, WaterPressureAbility.INSTANCE};
    public static final Ability[] WIND_ZANPAKUTO = new Ability[] {GaleForceAbility.INSTANCE, WhirldWindDanceAbility.INSTANCE, WindAttackAbility.INSTANCE, WindBladeAbility.INSTANCE, WindDodgeAbility.INSTANCE};
