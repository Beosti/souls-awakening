...
public class ModBiomes {
    ...
    public static final RegistryObject<Biome> SOUL_SOCIETY_SHADOW = BIOMES.register("soul_society_shadow", () -> makeSoulSocietyShadowBiome(() -> ModConfiguredSurfaceBuilders.SOUL_SOCIETY, -0.105f, -0.105f));

    public static Biome makeSoulSocietyShadowBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder, float depth, float scale) {
