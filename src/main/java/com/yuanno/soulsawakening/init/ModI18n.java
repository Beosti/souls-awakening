...
public class ModI18n {
    ...
    public static final TranslationTextComponent CHALLENGE_MESSAGE_START_TITLE = new TranslationTextComponent("challenge.message.start_title", "Starting Challenge");
