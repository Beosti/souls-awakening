...
public class ShinigamiUniformSandalsModel<T extends LivingEntity> extends BipedModel<T> {
	...
	public ShinigamiUniformSandalsModel() {
        super(1);
        texWidth = 128;
		texHeight = 128;
	...
	{
		this.shinigamiuniformleftboot.copyFrom(this.leftLeg);
		this.shinigamiuniformleftboot.render(matrixStack, buffer, packedLight, packedOverlay);
		this.shinigamiuniformrightboot.copyFrom(this.rightLeg);
		this.shinigamiuniformrightboot.render(matrixStack, buffer, packedLight, packedOverlay);
	}
