...
public class HadoProjectiles {
    ...
    public static void registerEntityRenderers(FMLClientSetupEvent event)
    {
        RenderingRegistry.registerEntityRenderingHandler(SHO.get(), new AbilityProjectileRenderer.Factory(new CubeModel())
                .setScale(1, 1, 1)
                .setColor("FFFFFF"));
        RenderingRegistry.registerEntityRenderingHandler(BYAKURAI.get(), new StretchingProjectileRenderer.Factory(new CubeModel()).setStretchScale(0.2, 0.2).setColor("#ADD8E6"));
