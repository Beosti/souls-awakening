...
public class CommandZanpakutoScreen extends Screen {
    ...
    public void init()
    {
        ...
        this.nameEdit.insertText("Zanpakuto command");
    ...
    private void updateName()
    {
        ...
        shinigamiStats.setZanpakutoCommand(this.nameEdit.getValue());
    ...
    {
        String zanpakutoCommand = this.nameEdit.getValue();
        this.init(minecraft, x, y);
        this.nameEdit.insertText(zanpakutoCommand);
    }
    @Override
    ...
    {
        Minecraft.getInstance().setScreen(new CommandZanpakutoScreen());
    }
    @Override
    public void onClose() {
        IEntityStats entityStats = EntityStatsCapability.get(player);
        ...
        this.player.sendMessage(new StringTextComponent(command.toUpperCase() + " " + name.toUpperCase()), Util.NIL_UUID);
        super.onClose();
    }
}
